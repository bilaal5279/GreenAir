    ...
    <div>
      <div className="flex flex-col justify-center items-center mt-16">
        ...
        <div className="text-center">
          <button type="button" className="mt-12 ml-3 text-white bg-black border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-bold rounded-full text-2xl sm:text-3xl px-4 sm:px-6 lg:px-8 py-2 sm:py-3 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
            Contact Us
          </button>
        </div>
      </div>
